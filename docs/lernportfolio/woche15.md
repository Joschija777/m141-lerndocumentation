...
Wir haben heute an der letzten abgabe Angefangen und ein Loging angeschaut mit 2 verschiedenen Rechten.
...
## Wie war es?
Es war intressant gestaltet und ich durfte lernen wie man ein user und ein admin loging kann gestalten.
...
Die meissten Arbeiten sind mir leicht gefallen aber andere die ich bei der nächsten Aufgabe "Was ich gelernt habe?" Schwer gefallen sind.
...
Wie der User Controller zum Teil funktioniert!
...
class Users extends Controller
{
    ...
    public function index($pagename = 'User / Index')
    {
        ...
        echo $this->twig->render('user/index.twig.html', ['title' => $pagename, 'urlroot' => URLROOT, 'data' => $data, 'session' => $_SESSION]);
    }
